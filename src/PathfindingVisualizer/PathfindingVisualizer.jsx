    ...
    return (
      <div>
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark ">
          <a className="navbar-brand" href="/" style={{ fontSize: '2.5rem', fontWeight: 'bold',  textDecoration: 'none', color: 'white'}}>
        ...
        <button
          type="button"
          style={{ backgroundColor: '#3498DB', color: 'white', padding: '10px 20px', borderRadius: '10px' }}
